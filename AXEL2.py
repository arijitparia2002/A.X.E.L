...
from AXEL_UI2 import Ui_MainWindow
import Main
import sys
...
class GuiStart(QMainWindow):
    ...
    def startFunc(self):
        ...
        self.axel_ui.movies = QtGui.QMovie('Database\\GUI\\initial.gif')
        self.axel_ui.initiating_2.setMovie(self.axel_ui.movies)
        self.axel_ui.movies.start()
        ...
        self.axel_ui.movies = QtGui.QMovie('Database\\GUI\\reactor3.gif')
        ...
        self.axel_ui.movies = QtGui.QMovie('Database\\GUI\\Code2.gif')
        self.axel_ui.gif1_2.setMovie(self.axel_ui.movies)
        self.axel_ui.movies.start()

        self.axel_ui.movies = QtGui.QMovie('Database\\GUI\\world_report.gif')
        self.axel_ui.world_report.setMovie(self.axel_ui.movies)
        self.axel_ui.movies.start()

        self.axel_ui.movies = QtGui.QMovie('Database\\GUI\\source.gif')
        self.axel_ui.smoke.setMovie(self.axel_ui.movies)
        self.axel_ui.movies.start()
